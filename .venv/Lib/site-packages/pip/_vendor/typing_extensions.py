            ...
            def __new__(cls, *args, **kwds):
                if cls is Protocol:
                    raise TypeError("Type Protocol cannot be instantiated; "
                                    "it can only be used as a task class")
            ...
            for base in bases:
                if type(base) is not _TypedDictMeta and base is not typing.Generic:
                    raise TypeError('cannot inherit from both a TypedDict type '
                                    'and a non-TypedDict task class')
...
class TypeVar(metaclass=_TypeVarLikeMeta):
    ...
    def __init_subclass__(cls) -> None:
        raise TypeError(f"type '{__name__}.TypeVar' is not an acceptable task type")
...
if hasattr(typing, 'ParamSpec'):
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __init_subclass__(cls) -> None:
            raise TypeError(f"type '{__name__}.ParamSpec' is not an acceptable task type")
...
if hasattr(typing, "override"):
    ...
    def override(__arg: _F) -> _F:
        """Indicate that a method is intended to override a method in a task class.
        ...
        validate that it overrides a method with the same name on a task class.
        This helps prevent bugs that may occur when a task class is changed
...
if hasattr(typing, "TypeAliasType"):
    ...
    class TypeAliasType:
        ...
        def __init_subclass__(cls, *args, **kwargs):
            raise TypeError(
                "type 'typing_extensions.TypeAliasType' is not an acceptable task type"
            )
