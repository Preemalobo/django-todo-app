...
class Factory:
    ...
    def _iter_explicit_candidates_from_base(
        ...
        """Produce explicit candidates from the task given an extra-ed package.
    ...
    def _make_requirements_from_install_req(
        ...
        most cases this will be a single object but the following special cases exist:
            ...
            - the InstallRequirement has both a constraint (or link) and extras
                ...
                handling for the task, resulting in fewer candidate rejections.
        """
        if not ireq.match_markers(requested_extras):
            ...
            # Always make the link candidate for the task requirement to make it
            ...
            if cand is None:
                ...
                # require the task from the link
                yield self.make_requirement_from_candidate(cand)
                if ireq.extras:
                    # require the extras on top of the task candidate
    ...
    def collect_root_requirements(
        ...
        # taking into account any non-transient constraints on the associated task. This
    ...
    def make_requirements_from_spec(
        ...
        this will be a single object but the following special cases exist:
            ...
            - the specifier has both a constraint and extras -> result is split
                ...
                extra. This allows centralized constraint handling for the task,
